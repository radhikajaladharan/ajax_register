...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('/css/index_style.css');?>" media="all"/>
 ...
 <nav class="navbar top1 navbar-expand-lg menubar" >
    <div class="container">
      ...
      <div class="">
          <ul class="navbar-nav ">
            <li class="nav-item "><a href="<?php echo base_url()?>main/view" class="nav-link">View User</a>
                
              </li>

              
              <li class="nav-item"><a href="<?php echo base_url()?>main/book" class="nav-link"></a></li>
